...
import { LissajousDrawer } from './lissajous-drawer';
...
export class LissajousView {
  ...
  // Método getter para sliders
  public getSliders() {
    return this.sliders;
  }

  // Método getter para valueDisplays
  public getValueDisplays() {
    return this.valueDisplays;
  }

  // Método getter para context
  public getContext() {
    return this.context;
  }

  // Método getter para grid
  public getGrid() {
    return this.grid;
  }
  /**
